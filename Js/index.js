...
function meterToFeet(number) {
    ...
    return `${number} meters = ${(number * 3.28084).toFixed(3)} feet`;

}

function feetToMeter(number) {

    return `${number} feet = ${(number / 3.28084).toFixed(3)} meters`;
...
function litresToGallon(number) {
    ...
    return `${number} litres = ${(number * 0.264172).toFixed(3)} gallons`;

}

function gallonToLitres(number) {

    return `${number} gallons = ${(number / 0.264172).toFixed(3)} litres`;

}
 
function kgToPounds(number) {

    return `${number} kilos = ${(number * 2.20462).toFixed(3)} pounds`;

}

function poundsToKg(number) {

    return `${number} pounds = ${(number / 2.20462).toFixed(3)} kilos`;
